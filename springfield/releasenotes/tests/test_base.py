...
from springfield.firefox.firefox_details import FirefoxDesktop
from springfield.releasenotes import views
from springfield.releasenotes.models import Note, ProductRelease
