...
PROJECT_MODULE = "springfield"  # TODO: remove me? - seems redundant
...
if ENABLE_CSP_MIDDLEWARE:
    MIDDLEWARE.append("springfield.base.middleware.CSPMiddlewareByPathPrefix")
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "springfield.base.context_processors.i18n",
                "springfield.base.context_processors.globals",
                "springfield.base.context_processors.geo",
...
CSRF_FAILURE_VIEW = "springfield.base.views.csrf_failure"
